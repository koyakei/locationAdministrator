...
import kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.criminalLaw.構成要件該当性判定
...
) : 構成要件該当性判定<kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.criminalLaw.carAccident.交通事故の刑事的事実> {
