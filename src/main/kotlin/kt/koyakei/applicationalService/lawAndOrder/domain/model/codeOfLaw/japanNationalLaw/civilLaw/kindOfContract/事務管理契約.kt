...
class 事務管理契約(
    ...
    val 事務管理に伴って発生した債務: kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.debt.債務,
    val v事務管理対象: kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.kindOfContract.事務管理契約.事務管理対象,
    override val 契約者当事者List: List<kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.契約当事者>// これ　事務管理だと最初に管理しておく人と管理の利益を受ける人に分かれる。
...
) : kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.契約 {
    /**
     * 瓦が飛びました
     */
    @JvmInline
    ...
    override fun 契約履行判定(): kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.契約.契約履行済み {
        return kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.契約.契約履行済み(事務管理に伴って発生した債務.履行済みかどうか == kt.koyakei.applicationalService.lawAndOrder.domain.model.codeOfLaw.japanNationalLaw.civilLaw.debt.債務.履行済み判定(true)) // 債務解消済みかはんてい　
    }
}